...
#Use Python to create a simple calculator that accepts Reverse Polish Notation (RPN) and displays the final answer (Intermediate steps or results need not be
# displayed).

#Importing os inorder to catch the input file (input_RPN.txt) path
import os
...
class PostFixStack:
    ...
    def infix_to_postfix(equation, d_e_p_t_h):
        ...
        for s in d_e_p_t_h:
            ...
            # push it to stack ,if the character is an '('
            elif s == '(':
                equation.push(s)
        ...
        print("INPUT RPN: " + "".join(equation.output))
...
if __name__ == '__main__':
    ...
    RPN_inputFile_location_path = os.path.join(Python_file_path, "input_RPN.txt")
